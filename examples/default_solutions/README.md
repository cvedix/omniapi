...
```json
{
  ...
  "additionalParams": {
    ...
    "MODEL_PATH": "/opt/omniapi/models/yolo/yolov8.weights",
    "CONFIG_PATH": "/opt/omniapi/models/yolo/yolov8.cfg",
    "LABELS_PATH": "/opt/omniapi/models/yolo/coco.names"
  }
}
```
...
```json
{
  ...
  "additionalParams": {
    ...
    "MODEL_CONFIG_PATH": "/opt/omniapi/models/mask_rcnn/mask_rcnn.pbtxt",
...
```json
{
  ...
  "additionalParams": {
    ...
    "WEIGHTS_PATH": "/opt/omniapi/models/yolo/yolov8.weights",
    "CONFIG_PATH": "/opt/omniapi/models/yolo/yolov8.cfg",
    "LABELS_PATH": "/opt/omniapi/models/yolo/coco.names",
