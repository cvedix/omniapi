...
// TensorRT Detectors (removed)

        // RKNN Detectors (removed)
...
// Face Processing Nodes
        {"face_detector",
         {"detector",
          ...
          "Face Detector",
          "Face detection using YuNet (OpenCV FaceDetectorYN)"}},
        // ========== PROCESSOR NODES ==========
        ...
        {"ba_event_extraction",
         {"broker",
          ...
          {"include_crop_images"},
          "BA Event Extraction",
          "Extract BA events to structured JSON with target details and timestamps"}},
