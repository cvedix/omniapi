...
DEB_FILE="edgeos-api-with-sdk-2026.0.1.21-amd64.deb"
...
case $choice in
    1)
        ...
        echo "  $DOCKER_COMPOSE_CMD -f docker-compose.test.yml exec edgeos-api-test bash"
        echo ""
        echo "Để xem logs:"
    ...
    2)
        ...
        echo ""
        echo "Để chạy container:"
        echo "  docker run -it --privileged --name edgeos-api-test \\"
        echo "    -v /sys/fs/cgroup:/sys/fs/cgroup:ro \\"
        echo "    -p 8080:8080 \\"
        echo "    edgeos-api-test:latest"
        echo ""
        echo "Hoặc chạy ở background:"
        echo "  docker run -d --privileged --name edgeos-api-test \\"
        echo "    -v /sys/fs/cgroup:/sys/fs/cgroup:ro \\"
        echo "    -p 8080:8080 \\"
        echo "    edgeos-api-test:latest"
        echo ""
        echo "Để vào container:"
        echo "  docker exec -it edgeos-api-test bash"
        ;;
    3)
        echo ""
        echo "=== Build image ==="
        ...
        echo "✓ Build thành công!"
        echo ""
        echo "Image đã được tạo: edgeos-api-test:latest"
